...
public class VisionLineUpWithTargetCommand extends CommandBase {
   ...
   */
  public VisionLineUpWithTargetCommand(SwerveDriveSubsystem drivetrain, SocketVisionWrapper vision) {
