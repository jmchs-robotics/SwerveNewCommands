...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_secondaryController_B.whileHeld( // whenHeld doesn't restart the command if it finishes; useful for command groups to only run once. 
      new SetThrowerSpeedCommand(m_Thrower, 800) // m_Thrower.getThrowerSpeed()) // .perpetually() lets the command run forever.
    //)
    //.whenReleased(
